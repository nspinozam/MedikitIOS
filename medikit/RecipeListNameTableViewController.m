//
//  RecipeListNameTableViewController.m
//  medikit
//
...
@interface RecipeListNameTableViewController ()
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"genericName" ascending:NO];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    nameLabel.text = [NSString stringWithFormat:@"%@/%@", object.genericName, object.comercialName];
